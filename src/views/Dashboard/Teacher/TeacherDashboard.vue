            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li class="scroll-to-section"><a href="#contact">Quiz</a></li>
                      <li class="scroll-to-section"><a href="/student/login">Add Quiz</a></li>
                      <li class="scroll-to-section"><a href="/teacher/login">Add Questions</a></li>
                      <li class="scroll-to-section"><a href="/teacher/login">Logout</a></li>
                  </ul>   
